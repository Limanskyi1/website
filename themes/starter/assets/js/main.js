...
document.addEventListener('DOMContentLoaded', function () {
  ...
  var laptopScreen = window.matchMedia('(min-width: 992px)');
  var startAnim = '-100 center';
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  var createScrollAnimationTo = function createScrollAnimationTo(selector, trigger, start, end, scrub, animationProps) {
    gsap.from(selector, _objectSpread({
      scrollTrigger: {
        trigger: trigger,
        start: start,
...
var companyItems = document.querySelectorAll('.company__item');

var hoverAnim = function hoverAnim(items) {
...
document.addEventListener('DOMContentLoaded', function () {
  var burgerButton = document.querySelector('.btn-burger');
...
function animateIncomeValue(element, startValue, endValue, duration) {
  ...
  var totalSteps = Math.ceil(duration / stepTime);
  var stepValue = range / totalSteps;
...
function startAnimationWhenVisible() {
  var incomeElements = document.querySelectorAll(".income-value");
  var startValue = 0;
  var duration = 2500;
  incomeElements.forEach(function (element) {
    var endValue = parseInt(element.dataset.endValue);
    var elementPosition = element.getBoundingClientRect().top;
    var windowHeight = window.innerHeight;
    var isElementAnimated = element.dataset.animated === "true";
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  window.addEventListener('scroll', function () {
    ...
    scrollPercentage > 99.9 ? scroller.classList.add('done') : scroller.classList.remove('done'); // Обновляем текст внутри элемента <text> с текущим значением scrollPercentage
...
document.addEventListener("DOMContentLoaded", function () {
  function updateURL(param) {
    if (history.pushState) {
      ...
      var newUrl = baseUrl + "?doc=".concat(param);
  ...
  var tabNav = Array.from(document.querySelectorAll('.tabs-nav__item')),
  ...
  if (paramURL) {
    var activeEl = paramURL.replace('?doc=', '');
...
/* harmony import */ var _js_initMenu_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @/js/initMenu.js */ "./js/initMenu.js");
/* harmony import */ var _js_initMenu_js__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(_js_initMenu_js__WEBPACK_IMPORTED_MODULE_2__);
/* harmony import */ var _js_initHeader_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @/js/initHeader.js */ "./js/initHeader.js");
/* harmony import */ var _js_initHeader_js__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(_js_initHeader_js__WEBPACK_IMPORTED_MODULE_3__);
/* harmony import */ var _js_initScrollerTop_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @/js/initScrollerTop.js */ "./js/initScrollerTop.js");
/* harmony import */ var _js_initScrollerTop_js__WEBPACK_IMPORTED_MODULE_4___default = /*#__PURE__*/__webpack_require__.n(_js_initScrollerTop_js__WEBPACK_IMPORTED_MODULE_4__);
/* harmony import */ var _js_redirect_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! @/js/redirect.js */ "./js/redirect.js");
/* harmony import */ var _js_redirect_js__WEBPACK_IMPORTED_MODULE_5___default = /*#__PURE__*/__webpack_require__.n(_js_redirect_js__WEBPACK_IMPORTED_MODULE_5__);
/* harmony import */ var _js_initAnimations_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! @/js/initAnimations.js */ "./js/initAnimations.js");
/* harmony import */ var _js_initAnimations_js__WEBPACK_IMPORTED_MODULE_6___default = /*#__PURE__*/__webpack_require__.n(_js_initAnimations_js__WEBPACK_IMPORTED_MODULE_6__);
/* harmony import */ var _js_animHome_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! @/js/animHome.js */ "./js/animHome.js");
/* harmony import */ var _js_animHome_js__WEBPACK_IMPORTED_MODULE_7___default = /*#__PURE__*/__webpack_require__.n(_js_animHome_js__WEBPACK_IMPORTED_MODULE_7__);
/* harmony import */ var _js_animAbout_js__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! @/js/animAbout.js */ "./js/animAbout.js");
/* harmony import */ var _js_animAbout_js__WEBPACK_IMPORTED_MODULE_8___default = /*#__PURE__*/__webpack_require__.n(_js_animAbout_js__WEBPACK_IMPORTED_MODULE_8__);
/* harmony import */ var _js_initTabsDocs_js__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! @/js/initTabsDocs.js */ "./js/initTabsDocs.js");
/* harmony import */ var _js_initTabsDocs_js__WEBPACK_IMPORTED_MODULE_9___default = /*#__PURE__*/__webpack_require__.n(_js_initTabsDocs_js__WEBPACK_IMPORTED_MODULE_9__);
/* harmony import */ var _js_hoverItemAnim_js__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! @/js/hoverItemAnim.js */ "./js/hoverItemAnim.js");
/* harmony import */ var _js_hoverItemAnim_js__WEBPACK_IMPORTED_MODULE_10___default = /*#__PURE__*/__webpack_require__.n(_js_hoverItemAnim_js__WEBPACK_IMPORTED_MODULE_10__);
/* harmony import */ var _js_initRunningNumbers_js__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! @/js/initRunningNumbers.js */ "./js/initRunningNumbers.js");
/* harmony import */ var _js_initRunningNumbers_js__WEBPACK_IMPORTED_MODULE_11___default = /*#__PURE__*/__webpack_require__.n(_js_initRunningNumbers_js__WEBPACK_IMPORTED_MODULE_11__);
/* harmony import */ var _js_imageScroll_js__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! @/js/imageScroll.js */ "./js/imageScroll.js");
/* harmony import */ var _js_imageScroll_js__WEBPACK_IMPORTED_MODULE_12___default = /*#__PURE__*/__webpack_require__.n(_js_imageScroll_js__WEBPACK_IMPORTED_MODULE_12__);
...
document.addEventListener('DOMContentLoaded', function () {
  var getPageLangCode = function getPageLangCode() {
    var htmlLangAttr = document.getElementsByTagName('html')[0].getAttribute('lang');
    var langCodes = {
      'ru-RU': 'ru',
      'en-US': 'en',
      'de-DE': 'de',
  ...
  var LOG_TRADE_LINK = "https://trade.".concat(document.location.hostname, "/auth/login?lang=").concat(getPageLangCode());
  var REG_TRADE_LINK = "https://trade.".concat(document.location.hostname, "/auth/register?lang=").concat(getPageLangCode());
  var logElemenets = document.querySelectorAll("a[data-link='log']");
  logElemenets.forEach(function (item) {
    item.href = LOG_TRADE_LINK;
  });
  var regElemenets = document.querySelectorAll("a[data-link='reg']");
  regElemenets.forEach(function (item) {
