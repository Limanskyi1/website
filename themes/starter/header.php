    ...
    <header id="header" class="header">
        <div class="container header__container">
            <div class="header__inner">
                ...
                <? } else { ?>
                    <a href="<?= get_home_url(); ?>" class="header__logo-mob">
                        <img src="<?= get_template_directory_uri() . '/assets/img/home/logo.svg' ?>" alt="header logo">
                    </a>
                <? } ?>
                ...
                <div class="btn-lang">
                    ...
                    ?>
                    <div class="arrow">
                        <img src="<?= get_template_directory_uri() . '/assets/img/home/arrow.svg' ?>" alt="header logo">
                    </div>
                </div>
                <div class="header__btns">
                    <a href="" class="btn-log" data-link="log">
                        <span>
                            <? _e('[:ru]Войти[:en]Log in[:]'); ?>
                        </span>
                    </a>
                    <a href="" class="btn-common" data-link="reg">
                        <? _e('[:ru]Открыть счет[:en]Open account[:]'); ?>
                    </a>
                </div>
                ...
                <button class="header__burger btn-menu btn-burger">
                    <span></span>
                    <span></span>
                    <span></span>
                </button>
